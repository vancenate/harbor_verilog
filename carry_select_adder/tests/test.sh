...
# Formal verification test script for 24-bit Carry Select Adder circuit
set -e

echo "=== Starting formal verification for 24-bit Carry Select Adder circuit ==="
...
# Copy solution_core.sv to tests directory (full_adder.sv, rca.sv, solution_top.sv, solution_assertions.sv are already in tests/)
