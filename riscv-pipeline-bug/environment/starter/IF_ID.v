...
assign pipe.reg_rdata1[31: 0] = (pipe.src1_select == 5'h0) ? 32'h0 :
                        (!pipe.wb_stall && pipe.wb_alu_to_reg && !pipe.wb_mem_to_reg && (pipe.wb_dest_reg_sel == pipe.src1_select)) ? pipe.wb_result :
                        pipe.regs[pipe.src1_select];
assign pipe.reg_rdata2[31: 0] = (pipe.src2_select == 5'h0) ? 32'h0 :
                        (!pipe.wb_stall && pipe.wb_alu_to_reg && !pipe.wb_mem_to_reg && (pipe.wb_dest_reg_sel == pipe.src2_select)) ? pipe.wb_result :
