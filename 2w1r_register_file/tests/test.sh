...
# Formal verification test script for 2w1r_register_file (2R1W register file) circuit
set -e

echo "=== Starting formal verification for 2w1r_register_file (2R1W register file) circuit ==="
